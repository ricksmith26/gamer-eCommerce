            ...
            <div className="ViewBasketContainer">
                {this.props.userProfile.user_address1 ? <div><h2 className="viewBasketTitle">Delivery Address</h2>
                    <div>
                        ...
                        <div className="yellowBtn roundedYellow" onClick={() => this.handleConfirm()}>Confirm and proceed to payment</div>
                    </div>
                </div>
                : <div>
                    <div className="yellowBtn roundedYellow" onClick={() => this.handleOpenLogin()}>Login to Continue</div>
                </div>
                }
            </div>
        )
